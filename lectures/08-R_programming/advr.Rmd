...
- Questions regarding HW1 problem 3 from Viraj (everyone should thank him)
  ...
  _ans_: you can multiple a scaler to a matrix.  The result is an element-wise multiplication of the scaler with every entry in the matrix.  You might want to try as.numeric(scaler) * matrix.
