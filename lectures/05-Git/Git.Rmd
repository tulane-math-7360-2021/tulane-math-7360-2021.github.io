...
## Announcement
 ...
 - Friday class will be self-paced.
...
- Initialize a project.
    ...
    - Create a repository, e.g., `tulane-math-7360-2021` on GitHub.
    
    - Clone the repository to your local machine:
    ```{bash, eval=FALSE}
    git clone https://github.com/tulane-math-7360-2021/Math-7360-Xiang-Ji.git
    ```
...
- Create a private repository `Math-7360-FirstName-LastName` on `tulane-math-7360-2021`.
...
- Clone the repository, create `develop` branch, where you work on solutions.
    ...
    ```{bash, eval=FALSE}
    # clone the project
    git clone https://github.com/tulane-math-7360-2021/tulane-math-7360-2021.github.io.git
    # enter project folder
    cd tulane-math-7360-2021
