<?php
	...
	$encryption_key		= 'math-7260';			// Unique 8 to 32 character encryption key
	$notification_email	= 'pku.ji.xiang@gmail.com';	// E-mail for notification of new comments
	$admin_nickname		= 'xji3';			// Nickname with admin rights (must be title-cased)
	$admin_password		= 'math-7260';			// Password to gain admin rights
